...
export PYTHONPATH=$PYTHONPATH:/publicfs/cms/user/turuobing/CMSSW_10_6_20/src/FourTop/hua/src_py/
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/publicfs/cms/user/turuobing/CMSSW_10_6_20/src/FourTop/myLibrary/
