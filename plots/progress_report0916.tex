...
\begin{frame}{1Tau1L}
    ...
    \column{.5\textwidth}
    \centering
    \includegraphics[width=4.0cm]{NumofTops1Tau1L.png}\\
    \includegraphics[width=4.0cm]{LeadingTopPt1Tau1L.png}
    \column{.5\textwidth}
    \centering
    \includegraphics[width=4.0cm]{SecondTopPt1Tau1L.png}\\
    \includegraphics[width=4.0cm]{NumSelBJetsM1Tau1L.png}
    \end{columns}
\end{frame}
\begin{frame}{1Tau1L}
    \begin{columns}[t]
...
\begin{frame}{1Tau1L}
    ...
    \includegraphics[width=4.1cm]{MaxDeltaRBJets1Tau1L.png}
    \end{columns}
\end{frame}
\begin{frame}{1Tau1L}
    \begin{columns}[t]
    \column{.5\textwidth}
    \centering
    \includegraphics[width=4.1cm]{Met\_pt1Tau1L.png}\\%Met_pt1Tau1L.png
    \includegraphics[width=4.1cm]{MHTDividedByMET1Tau1L.png}
    \column{.5\textwidth}
    \centering
    \includegraphics[width=4.1cm]{MaxDeltaRJets1Tau1L.png}\\
...
\begin{frame}{1Tau2OS}
    ...
    \includegraphics[width=4.1cm]{MaxDeltaRBJets1Tau2OS.png}
    \end{columns}
\end{frame}
...
\begin{frame}{2Tau1L}
    ...
    \includegraphics[width=4.1cm]{MaxDeltaRBJets2Tau1L.png}
    \end{columns}
\end{frame}
