...
\graphicspath{ {/publicfs/cms/user/huahuil/TauOfTTTT/2016v1/v3_NewNtupleAfterEventSelection/plots/} }
...
\begin{frame}{1Tau0L}
    ...
    \column{.5\textwidth}
    \centering
    \includegraphics[width=4.1cm]{NumOfTausF1Tau0L_v2.png}\\
...
%    \caption{background is all the samples excerpt W + Jets. normarlized to cross section}
    \column{.5\textwidth}
    \centering
    \includegraphics[width=4.1cm]{NumOfTausL1Tau0L_v2.png}
    \end{columns}
\end{frame}
\begin{frame}{1Tau0L}
    \begin{columns}[t]
