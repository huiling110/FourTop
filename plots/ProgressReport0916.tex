...
%\section*{Distribution of Signal Vs Background}


%\begin{frame}{Distribution of Signal Vs Background-1Tau1L}
%    \begin{itemize}
%    \item
...
%    \column{.5\textwidth}
%    \centering
%%    \includegraphics[width=5cm,height=4cm]{NumofTops.png}\\
%    \includegraphics[width=5cm]{NumofTops_1Tau1L.png}\\%NumofTops_1Tau1L.png
%    \includegraphics[width=5cm]{LeadingTopPt_1Tau1L.png}
%    \column{.5\textwidth}
%    \centering
%    \includegraphics[width=5cm]{SecondTopPt_1Tau1L.png}\\
%    \includegraphics[width=5cm]{NumSelBJetsM_1Tau1L.png}
%    \end{columns}
%\end{frame}
...
%    \centering
%%    \includegraphics[width=5cm,height=4cm]{NumofTops.png}\\
%    \includegraphics[width=5cm]{NumofTops1Tau2OS.png}\\
%    \includegraphics[width=5cm]{LeadingTopPt1Tau2OS.png}
%    \column{.5\textwidth}
%    \centering
%    \includegraphics[width=5cm]{SecondTopPt1Tau2OS.png}\\
%    \includegraphics[width=5cm]{NumSelBJetsM1Tau2OS.png}
%    \end{columns}
%\end{frame}
...
\begin{frame}{Significance}
    ...
    \centering
    \small
    \footnotesizeUse \footnotesize for a 20% (linear) reduction in font size
    \setlength\tabcolsep{2pt}Reduce the amount of intercolumn whitespace
    \begin{tabular}{|l | l | c|}
    \resizebox{\textwidth}{!}{ 
        \begin{tabular}{|l | l |>{$}c<{$}|} 
