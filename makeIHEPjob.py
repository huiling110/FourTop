...
#        print >> subFile, "root -l -b -q "+rootplizer+"\'(\""+inputFile+"\")\'"
    print >> subFile, "root -l -b -q "+"\'"+rootplizer+"+(false,\""+inputFile+"\","+"\"/publicfs/cms/user/huahuil/TauOfTTTT/2016v1/v16_removeISOforE_change2SS2OS_invitializeAll/\")"+"\'"
...
#	shFile = "EventSelection_dineutrino_Resolved_2016"+"_"+sampleNumber+".sh"
    ...
    logFileName = "/publicfs/cms/user/huahuil/TauOfTTTT/2016v1/v16_removeISOforE_change2SS2OS_invitializeAll/log/"+"sampleName_"+sampleName+".log"
    errorFileName = "/publicfs/cms/user/huahuil/TauOfTTTT/2016v1/v16_removeISOforE_change2SS2OS_invitializeAll/log/"+"sampleName_"+sampleName+".err"
