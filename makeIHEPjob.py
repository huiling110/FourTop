...
#   	errorFileName = "/publicfs/cms/user/yutz/Tprime/Jobs_data/log/"+"Event_"+sampleNumber+".err"
    logFileName = "/publicfs/cms/user/huahuil/TauOfTTTT/2016v1/v10_ObjectRemoval/log/"+"sampleName_"+sampleName+".log"
    errorFileName = "/publicfs/cms/user/huahuil/TauOfTTTT/2016v1/v10_ObjectRemoval/log/"+"sampleName_"+sampleName+".err"
