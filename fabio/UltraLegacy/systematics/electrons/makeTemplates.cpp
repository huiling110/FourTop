...
void makeTemplates(string year) {
    ...
    cout << "////////////////////////////////////////////////////////" << endl;
    cout << "////////////////////////////////////////////////////////" << endl;
    cout << "///////// REMEMBER TO UPDATE LUMI MAP!!! ////////////////" << endl;
    cout << "////////////////////////////////////////////////////////" << endl;
    cout << "////////////////////////////////////////////////////////" << endl;
    cout << "////////////////////////////////////////////////////////" << endl;
    cout << "////////////////////////////////////////////////////////" << endl;
    ...
    */
    ...
    TFile * input_EGammaSF = new TFile( TString(EGammaSF_files[year]), "READ" );
    ...
    */
	...
	while (file_it != file.end()) { //////////////////////// LOOP OVER FILES ///////////////////////
        ...
        TH1F * h_1tau1L_eleIDUp = new TH1F("h_1tau1L_eleIDUp", "h_1tau1L_eleIDUp", 11, 400, 1500);
        TH1F * h_1tau1L_eleIDDown = new TH1F("h_1tau1L_eleIDDown", "h_1tau1L_eleIDDown", 11, 400, 1500);
		TH1F * h_1tau3L_eleIDUp = new TH1F("h_1tau3L_eleIDUp", "h_1tau3L_eleIDUp", 11, 400, 1500);
        TH1F * h_1tau3L_eleIDDown = new TH1F("h_1tau3L_eleIDDown", "h_1tau3L_eleIDDown", 11, 400, 1500);
				...
				if (!(file_it->first.find(data) !=std::string::npos)) {
                    ...
                    */
                    ...
                    if(is1tau1L) {
                        ...
                        float eleIDSFUp = 1.0;
                        float eleIDSFDown = 1.0;
                        for (int i = 0; i < myelesMVAT->size(); i++) {

                            float thisEleIDSF = EGammaSF->GetBinContent(EGammaSF->FindBin(myelesMVAT->at(i).Eta(),myelesMVAT->at(i).Pt()));
                            float thisErr = EGammaSF->GetBinError(EGammaSF->FindBin(myelesMVAT->at(i).Eta(),myelesMVAT->at(i).Pt()));
                            eleIDSFUp = eleIDSFUp*(thisEleIDSF+thisErr);
                            eleIDSFDown = eleIDSFDown*(thisEleIDSF-thisErr);
		...
		*/
        ...
        writeHisto(h_1tau1L_eleIDUp, file_it);
        writeHisto(h_1tau1L_eleIDDown, file_it);
        writeHisto(h_1tau3L_eleIDUp, file_it);
        writeHisto(h_1tau3L_eleIDDown, file_it);
		//delete totalWeight;
