		...
		for ( Long64_t ievent = 0; ievent < nevents; ++ievent ) {
			...
			if (HT > 400) {
				...
				if (!(file_it->first.find(data) !=std::string::npos)) {
					...
					if(is1tau1L) h_1tau1L->Fill(myjetsL->size(), mygenEvtWeight * myPUWeight * myprefireWeight * mytriggerWeight * mybtagWeight[0]);
					if(is1tau2L) h_1tau2L->Fill(myjetsL->size(), mygenEvtWeight * myPUWeight * myprefireWeight * mytriggerWeight * mybtagWeight[0]);
					if(is1tau3L) h_1tau3L->Fill(myjetsL->size(), mygenEvtWeight * myPUWeight * myprefireWeight * mytriggerWeight * mybtagWeight[0]);
					if(is2tau0L) h_2tau0L->Fill(myjetsL->size(), mygenEvtWeight * myPUWeight * myprefireWeight * mytriggerWeight * mybtagWeight[0]);
					if(is2tau1L) h_2tau1L->Fill(myjetsL->size(), mygenEvtWeight * myPUWeight * myprefireWeight * mytriggerWeight * mybtagWeight[0]);
					if(is2tau2L) h_2tau2L->Fill(myjetsL->size(), mygenEvtWeight * myPUWeight * myprefireWeight * mytriggerWeight * mybtagWeight[0]);
