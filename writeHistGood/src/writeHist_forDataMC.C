...
void WH_forDataMC::Init()
{
    ...
    if(m_is1tau2l){
        regionsForVariables = {"1tau2lSR", "1tau2lCR3", "1tau2lCR4"};
    }else{
    ...
    for (UInt_t i = 0; i < allEvent; i++)
    {
        ...
        {   
            if(!m_is1tau2l){
                ...
                Bool_t is1tau2lSRTest = SR1tau1lSel(e, 2, m_isRun3, m_isFakeTau, m_isFakeLepton, !m_isData, m_ifFakeTau);
        ...
        Bool_t is1tau2lCR4 = SR1tau1lSel(e, 15, m_isRun3, m_isFakeTau, m_isFakeLepton, !m_isData, m_ifFakeTau);
        fillHistVec("1tau2lCR3", is1tau2lCR3, eventWeight_1tau2l );
        fillHistVec("1tau2lCR4", is1tau2lCR4, eventWeight_1tau2l );
        }
...
void WH_forDataMC::fillHistVec(TString region, Bool_t ifBaseline, Double_t basicWeight){
    ...
    if(m_ifSys){
        ...
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_hfUp", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_hf_up.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_hfDown", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_hf_down.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_lfUp", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_lf_up.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_lfDown", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_lf_down.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_hfstats1_"+m_era+"Up", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_hfstats1_up.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_hfstats1_"+m_era+"Down", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_hfstats1_down.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_hfstats2_"+m_era+"Up", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_hfstats2_up.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_hfstats2_"+m_era+"Down", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_hfstats2_down.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_lfstats1_"+m_era+"Up", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_lfstats1_up.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_lfstats1_"+m_era+"Down", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_lfstats1_down.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_lfstats2_"+m_era+"Up", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_lfstats2_up.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_lfstats2_"+m_era+"Down", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_lfstats2_down.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_cferr1Up", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_cferr1_up.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_cferr1Down", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_cferr1_down.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_cferr2Up", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_cferr2_up.v(), m_isData);
        WH::histRegionVectFill(histsForRegion_vec, ifBaseline, region+"_CMS_btag_cferr2Down", (basicWeight/e->btagShape_weight.v())*e->btagShape_weight_cferr2_down.v(), m_isData);
