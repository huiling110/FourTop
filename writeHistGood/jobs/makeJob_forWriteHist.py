...
def main(
    ...
    inputDir = '/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2018/v0baselineHadro_v94HadroPreJetVetoHemOnly_JERUp/', #!!V13
    ...
    # version = 'v0BDT1tau0lFakeTauPtMorphedV2',
