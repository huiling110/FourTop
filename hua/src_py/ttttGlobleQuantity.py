...
histoGramPerSample = { 
    ...
    # "vbfH_WW_2l": "Minor",#"Higgs", #!vbH_ww_2l probmatic in 2016 pre
...
dataDict = {
    ...
    '2016postVFP': ['2016F', '2016G', '2016H', '2016f', '2016g', '2016h', '2016postVFP'],  #!!!Might causing data double counting
    '2016preVFP': ['2016B_v1_v2', '2016B_v2_v2',  '2016C_v2', '2016D_v2', '2016E_v2', '2016F_hipm_v2', '2016b_v1', '2016b_v2', '2016b','2016c', '2016d', '2016e', '2016f_hipm', '2016preVFP'],
}
...
# Subprocesses to SKIP per channel - these have negligible contribution and add noise to systematics
# Based on analysis of subprocess contributions in 2018 SR and CR regions
...
SKIP_SUBPROCESSES = {
    '1tau1l': [
        ...
        # Note: st_schan_*, st_tchan_*, ttHJet* files don't exist (different naming or no events)
    ],
    '1tau0l': [
