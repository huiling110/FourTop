...
// Sat Feb  6 16:13:36 2021 by ROOT version 6.12/07
...
#ifndef makeVariblesTree_h
#define makeVariblesTree_h
...
class makeVariblesTree : public TSelector {
public :
   ...
   TTreeReaderValue<Int_t> eleL_number = {fReader, "eleL_number"};
   TTreeReaderValue<Int_t> eleM_number = {fReader, "eleM_number"};
   TTreeReaderValue<Int_t> eleT_number = {fReader, "eleT_number"};
   ...
   makeVariblesTree(TTree * /*tree*/ =0) { }
   virtual ~makeVariblesTree() { }
...
#ifdef makeVariblesTree_cxx
void makeVariblesTree::Init(TTree *tree)
{
...
Bool_t makeVariblesTree::Notify()
{
...
#endif // #ifdef makeVariblesTree_cxx
