...
#ifndef writeHist_forHLTStudy_h
#define writeHist_forHLTStudy_h
...
class writeHist_forHLTStudy : public TSelector
{
public:
    ...
    writeHist_forHLTStudy(TTree * /*tree*/ = 0) {}
    virtual ~writeHist_forHLTStudy() {}
    ...
    ClassDef(writeHist_forHLTStudy, 0);
};

#endif

#ifdef writeHist_forHLTStudy_cxx
void writeHist_forHLTStudy::Init(TTree *tree)
{
...
Bool_t writeHist_forHLTStudy::Notify()
{
...
#endif // #ifdef writeHist_forHLTStudy_cxx
