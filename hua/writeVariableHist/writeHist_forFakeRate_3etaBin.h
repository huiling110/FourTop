...
public:
    ...
    histsForRegions<Double_t> tausL_1pt_eta_class{"tausF_1jetPt", "#tau's mother jet  p_{T}(GeV)", 28, 20, 300, tausF_1jetPt};
    ...
    TTreeReaderValue<Int_t> elesTopMVAVPOG_number = {fReader, "elesTopMVAVPOG_number"};
    ...
    TTreeReaderValue<Int_t> tausF_genTauNum = {fReader, "tausF_genTauNum"};
    ...
    TTreeReaderValue<Double_t> tausF_1jetEtaAbs = {fReader, "tausF_1jetEtaAbs"};
