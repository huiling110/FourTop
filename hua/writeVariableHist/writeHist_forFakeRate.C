...
void writeHist_forFakeRate::SlaveBegin(TTree * /*tree*/)
{
    ...
    histsForRegions<Double_t> tausF_1eta_class{"tausF_1eta", "leading fake tau #eta", 10, -2.4, 2.4, tausF_1eta};
    ...
    std::vector<TString> regionsEtaDivided = {
        ...
        "1tau0lCRLTauNotTGen_Eta1", // 14
        "1tau0lCRLTauNotTGen_Eta2",

        // FR measurment CRc and CRa
        "1tau0lCRcLTau_Eta1", // 16
        "1tau0lCRcLTau_Eta2",
        "1tau0lCRcLTauGen_Eta1", // 18
        "1tau0lCRcLTauGen_Eta2",
        "1tau0lCRc_Eta1", // 20
        "1tau0lCRc_Eta2",
        "1tau0lCRcGen_Eta1", // 22
        "1tau0lCRcGen_Eta2",
        // CRa
        "1tau0lCRaLTau_Eta1", // 24
        "1tau0lCRaLTau_Eta2",
        "1tau0lCRaLTauGen_Eta1", // 26
        "1tau0lCRaLTauGen_Eta2",
        "1tau0lCRa_Eta1", // 28
        "1tau0lCRa_Eta2",
        "1tau0lCRaGen_Eta1", // 30
        "1tau0lCRaGen_Eta2",
        // CRb
        "1tau0lCRbLTau_Eta1", // 32
        "1tau0lCRbLTau_Eta2",
        "1tau0lCRbLTauGen_Eta1", // 34
