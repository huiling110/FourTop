...
void writeHist_forFakeRate_3etaBin::SlaveBegin(TTree * /*tree*/)
{
    ...
    std::vector<TString> regionsForFRWeighting = {
        ...
        "1tau0lCRb",                          // 35
        "1tau0lCRbGen",                       // 36
        "1tau0lCRbLTauNotT_Weighted",         // 37
        "1tau0lCRbLTauNotTGen_Weighted",      // 38
        "1tau0lCRbLTauNotT_Weighted_up",      // 39
        "1tau0lCRbLTauNotT_Weighted_down",    // 40
        "1tau0lCRbLTauNotTGen_Weighted_up",   // 41
        "1tau0lCRbLTauNotTGen_Weighted_down", // 42
    ...
    histsForRegions<Double_t> jets_5pt_class{"jets_5pt", "p_{T}^{5th jet}(GeV)", 10, 40, 250, jets_5pt};
    histsForRegions<Double_t> jets_6pt_class{"jets_6pt", "p_{T}^{6th jet}(GeV)", 10, 40, 180, jets_6pt};
    ...
    histsForRegions<Double_t> bjetsM_1pt_class{"bjetsM_1pt", "p_{T}^{1st bjet}(GeV)", 10, 25, 300, bjetsM_1pt};
    ...
    vectorOfVariblesRegions_FRweighted.push_back(tausF_1pt_class);
    vectorOfVariblesRegions_FRweighted.push_back(tausF_1eta_class);
    vectorOfVariblesRegions_FRweighted.push_back(tausT_1eta_class);
    ...
    std::vector<TString> regionsEtaDivided = {
        ...
        // CR LNotT
        "1tau0lCRLTauNotT_Eta1", // 16
        "1tau0lCRLTauNotT_Eta2",
        "1tau0lCRLTauNotTGen_Eta1", // 18
        "1tau0lCRLTauNotTGen_Eta2",

        // FR measurment CRc
        "1tau0lCRcLTau_Eta1", // 20
        "1tau0lCRcLTau_Eta2",
        "1tau0lCRcLTau_Eta3",    // 22
        "1tau0lCRcLTauGen_Eta1", // 23
        "1tau0lCRcLTauGen_Eta2", // 24
        "1tau0lCRcLTauGen_Eta3",
        "1tau0lCRc_Eta1", // 26
        "1tau0lCRc_Eta2",
        "1tau0lCRc_Eta3",    // 28
        "1tau0lCRcGen_Eta1", //
        "1tau0lCRcGen_Eta2", // 30
        "1tau0lCRcGen_Eta3", //
        // CRb
        "1tau0lCRbLTau_Eta1", // 32
        "1tau0lCRbLTau_Eta2",
        "1tau0lCRbLTau_Eta3", // 34
        "1tau0lCRbLTauGen_Eta1",
        "1tau0lCRbLTauGen_Eta2", // 36
        "1tau0lCRbLTauGen_Eta3",
        "1tau0lCRb_Eta1", // 38
        "1tau0lCRb_Eta2",
        "1tau0lCRb_Eta3", // 40
        "1tau0lCRbGen_Eta1",
        "1tau0lCRbGen_Eta2", // 42
        "1tau0lCRbGen_Eta3",
        ...
        "1tau0lVRGen_Eta3",
        // CRa
        "1tau0lCRaLTau_Eta1", // 56
        "1tau0lCRaLTau_Eta2",
        "1tau0lCRaLTauGen_Eta1", // 58
        "1tau0lCRaLTauGen_Eta2",
        "1tau0lCRa_Eta1", // 60
        "1tau0lCRa_Eta2",
        "1tau0lCRaGen_Eta1", // 62
        "1tau0lCRaGen_Eta2",
    ...
    std::map<TString, std::array<TString, 2>> FRfileMap = {
        ...
        // {"2017", {"/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2017/v5updateHLTSF_v52noHLTButPreSelection/mc/variableHists_v0FR_measureVR_1prong/results/fakeRateInPtEta_sumGenBG_newBin.root", "/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2017/v5updateHLTSF_v52noHLTButPreSelection/mc/variableHists_v0FR_measureVR_3prong/results/fakeRateInPtEta_sumGenBG_newBin.root"}},
        // {"2017", {"/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2017/v6baseline_v56NoHLTButPre/mc/variableHists_v0FR_measureVR_1prong/results/fakeRateInPtEta_sumGenBG_newBin.root", "/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2017/v6baseline_v56NoHLTButPre/mc/variableHists_v0FR_measureVR_3prong/results/fakeRateInPtEta_sumGenBG_newBin.root"}},
...
Bool_t writeHist_forFakeRate_3etaBin::Process(Long64_t entry)
{
    ...
    if (!m_isData)
    {
        //!!!make this the input parameter. how???
    ...
    if (!m_isData)
    {
        ...
        if (!m_ifMeasurement)
        {
            ...
            // CRb
            FillHistsVecorMyClassGenearal(is1tau0lCRbGen, 36, basicWeight, vectorOfVariblesRegions_FRweighted);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTauGen && noTauT, 38, basicWeight * FRWeight, vectorOfVariblesRegions_FRweighted);
            FillHistsVecorMyClassGenearal(is1tau0lCRbGen, 36, basicWeight, vectorOfVariblesRegions_FRweightedInt);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTauGen && noTauT, 38, basicWeight * FRWeight, vectorOfVariblesRegions_FRweightedInt);
            // CRb syst up and down regions
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTauGen && noTauT, 41, basicWeight * FRWeight_up, vectorOfVariblesRegions_FRweighted);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTauGen && noTauT, 42, basicWeight * FRWeight_down, vectorOfVariblesRegions_FRweighted);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTauGen && noTauT, 41, basicWeight * FRWeight_up, vectorOfVariblesRegions_FRweightedInt);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTauGen && noTauT, 42, basicWeight * FRWeight_down, vectorOfVariblesRegions_FRweightedInt);
        }
        ...
        tausL_1pt_eta_class.fillHistVec(23, basicWeight, is1tau0lCRcLTauGen && isEta1);
        tausL_1pt_eta_class.fillHistVec(24, basicWeight, is1tau0lCRcLTauGen && isEta2);
        tausL_1pt_eta_class.fillHistVec(24, basicWeight, is1tau0lCRcLTauGen && isEta3);
        tausL_1pt_eta_class.fillHistVec(29, basicWeight, is1tau0lCRcGen && isEta1);
        tausL_1pt_eta_class.fillHistVec(30, basicWeight, is1tau0lCRcGen && isEta2);
        tausL_1pt_eta_class.fillHistVec(31, basicWeight, is1tau0lCRcGen && isEta3);
        // CRb
        tausL_1pt_eta_class.fillHistVec(35, basicWeight, is1tau0lCRbLTauGen && isEta1);
        tausL_1pt_eta_class.fillHistVec(36, basicWeight, is1tau0lCRbLTauGen && isEta2);
        tausL_1pt_eta_class.fillHistVec(37, basicWeight, is1tau0lCRbLTauGen && isEta3);
        tausL_1pt_eta_class.fillHistVec(41, basicWeight, is1tau0lCRbGen && isEta1);
        tausL_1pt_eta_class.fillHistVec(42, basicWeight, is1tau0lCRbGen && isEta2);
        tausL_1pt_eta_class.fillHistVec(43, basicWeight, is1tau0lCRbGen && isEta3);
        // VR for measure
        ...
        // CRa
        tausL_1pt_eta_class.fillHistVec(58, basicWeight, is1tau0lCRaLTauGen && isEta1);
        tausL_1pt_eta_class.fillHistVec(59, basicWeight, is1tau0lCRaLTauGen && isEta2);
        tausL_1pt_eta_class.fillHistVec(62, basicWeight, is1tau0lCRaGen && isEta1);
        tausL_1pt_eta_class.fillHistVec(63, basicWeight, is1tau0lCRaGen && isEta2);
    }
    else
    {
        ...
        if (!m_ifMeasurement)
        {
            ...
            // CRb
            FillHistsVecorMyClassGenearal(is1tau0lCRb, 35, basicWeight, vectorOfVariblesRegions_FRweighted);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTau && noTauT, 37, basicWeight * FRWeight, vectorOfVariblesRegions_FRweighted);
            FillHistsVecorMyClassGenearal(is1tau0lCRb, 35, basicWeight, vectorOfVariblesRegions_FRweightedInt);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTau && noTauT, 37, basicWeight * FRWeight, vectorOfVariblesRegions_FRweightedInt);
            // CRb syst up and down regions
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTau && noTauT, 39, basicWeight * FRWeight_up, vectorOfVariblesRegions_FRweighted);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTau && noTauT, 40, basicWeight * FRWeight_down, vectorOfVariblesRegions_FRweighted);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTau && noTauT, 39, basicWeight * FRWeight_up, vectorOfVariblesRegions_FRweightedInt);
            FillHistsVecorMyClassGenearal(is1tau0lCRbLTau && noTauT, 40, basicWeight * FRWeight_down, vectorOfVariblesRegions_FRweightedInt);
        }
        ...
        tausL_1pt_eta_class.fillHistVec(22, basicWeight, is1tau0lCRcLTau && isEta3);
        tausL_1pt_eta_class.fillHistVec(26, basicWeight, is1tau0lCRc && isEta1);
        tausL_1pt_eta_class.fillHistVec(27, basicWeight, is1tau0lCRc && isEta2);
        tausL_1pt_eta_class.fillHistVec(28, basicWeight, is1tau0lCRc && isEta3);
        // CRb
        ...
        tausL_1pt_eta_class.fillHistVec(34, basicWeight, is1tau0lCRbLTau && isEta2);
        tausL_1pt_eta_class.fillHistVec(38, basicWeight, is1tau0lCRb && isEta1);
        tausL_1pt_eta_class.fillHistVec(39, basicWeight, is1tau0lCRb && isEta2);
        tausL_1pt_eta_class.fillHistVec(40, basicWeight, is1tau0lCRb && isEta2);
        // VR
        ...
        // CRa
        tausL_1pt_eta_class.fillHistVec(56, basicWeight, is1tau0lCRaLTau && isEta1);
        tausL_1pt_eta_class.fillHistVec(57, basicWeight, is1tau0lCRaLTau && isEta2);
        tausL_1pt_eta_class.fillHistVec(60, basicWeight, is1tau0lCRa && isEta1);
        tausL_1pt_eta_class.fillHistVec(61, basicWeight, is1tau0lCRa && isEta2);
    }
