...
#ifndef writeHist_forHLT_h
#define writeHist_forHLT_h
...
class writeHist_forHLT : public TSelector
{
public:
    ...
    TTreeReaderValue<Double_t> elesTopMVAT_1pt = {fReader, "elesTopMVAT_1pt"};
    TTreeReaderValue<Double_t> muonsTopMVAT_1pt = {fReader, "muonsTopMVAT_1pt"};
    TTreeReaderValue<Int_t> elesTopMVAT_1char = {fReader, "elesTopMVAT_1char"};
    TTreeReaderValue<Int_t> muonsTopMVAT_1char = {fReader, "elesTopMVAT_1char"};
    ...
    writeHist_forHLT(TTree * /*tree*/ = 0) {}
    virtual ~writeHist_forHLT() {}
    ...
    ClassDef(writeHist_forHLT, 0);
};

#endif

#ifdef writeHist_forHLT_cxx
void writeHist_forHLT::Init(TTree *tree)
{
...
Bool_t writeHist_forHLT::Notify()
{
...
#endif // #ifdef writeHist_forHLT_cxx
