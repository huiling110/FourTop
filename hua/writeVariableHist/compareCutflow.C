...
void compareCutflow()
{
    ...
    huaTree->BuildIndex("event_", "event_");
    huaTree->Print();
    ULong64_t huaEvent;
    ...
    if (huaTree->GetEntryWithIndex(361012, 361012))
    {
        cout << huaEvent << " " << huaPassJet6 << "\n";
    };
    ...
    */
    ...
    for (UInt_t en = 0; en < 100; en++)
    {
        ...
        // if (huaTree->GetEntryWithIndex(houEvent, houEvent) > 0)
        // {
        //     printf("event %llu", huaEvent);
        // };
