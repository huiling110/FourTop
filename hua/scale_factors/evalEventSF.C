double * evalEventSF( vector<TLorentzVector> * AK4Jets, vector<int> * AK4JetFlavor, vector<double> * AK4JetBtag, BTagCalibrationReader CSV_nominal) {
        ...
        if ( AK4Jets->size() > 0 ) { 
            ...
            for (int i = 0; i < AK4Jets->size(); i++) {
                ...
                if ( fabs(AK4JetFlavor->at(i)) == 5) { //b flavor
                    ...
                    double mycsv_weight_BF_ak4 = CSV_nominal.eval_auto_bounds("central", BTagEntry::FLAV_B, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_BF_ak4JESUp = CSV_nominal.eval_auto_bounds("up_jes", BTagEntry::FLAV_B, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_BF_ak4JESDown = CSV_nominal.eval_auto_bounds("down_jes", BTagEntry::FLAV_B, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    //no uncertainty on contamination from HF sample when computing HF scale factors
					double mycsv_weight_BF_ak4LFUp = CSV_nominal.eval_auto_bounds("up_lf", BTagEntry::FLAV_B, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_BF_ak4LFDown = CSV_nominal.eval_auto_bounds("down_lf", BTagEntry::FLAV_B, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_BF_ak4hfstats1Up = CSV_nominal.eval_auto_bounds("up_hfstats1", BTagEntry::FLAV_B, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_BF_ak4hfstats1Down = CSV_nominal.eval_auto_bounds("down_hfstats1", BTagEntry::FLAV_B, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_BF_ak4hfstats2Up = CSV_nominal.eval_auto_bounds("up_hfstats2", BTagEntry::FLAV_B, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_BF_ak4hfstats2Down = CSV_nominal.eval_auto_bounds("down_hfstats2", BTagEntry::FLAV_B, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    ...
                    double mycsv_weight_CF_ak4 = CSV_nominal.eval_auto_bounds("central", BTagEntry::FLAV_C, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i)); //always 1, checked
					double mycsv_weight_CF_ak4JESUp = CSV_nominal.eval_auto_bounds("up_jes", BTagEntry::FLAV_C, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_CF_ak4JESDown = CSV_nominal.eval_auto_bounds("down_jes", BTagEntry::FLAV_C, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_CF_ak4cfErr1Up = CSV_nominal.eval_auto_bounds("up_cferr1", BTagEntry::FLAV_C, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_CF_ak4cfErr1Down = CSV_nominal.eval_auto_bounds("down_cferr1", BTagEntry::FLAV_C, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_CF_ak4cfErr2Up = CSV_nominal.eval_auto_bounds("up_cferr2", BTagEntry::FLAV_C, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_CF_ak4cfErr2Down = CSV_nominal.eval_auto_bounds("down_cferr2", BTagEntry::FLAV_C, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    ...
                    double mycsv_weight_LF_ak4 = CSV_nominal.eval_auto_bounds("central", BTagEntry::FLAV_UDSG, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_LF_ak4JESUp = CSV_nominal.eval_auto_bounds("up_jes", BTagEntry::FLAV_UDSG, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_LF_ak4JESDown = CSV_nominal.eval_auto_bounds("down_jes", BTagEntry::FLAV_UDSG, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_LF_ak4HFUp = CSV_nominal.eval_auto_bounds("up_hf", BTagEntry::FLAV_UDSG, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_LF_ak4HFDown = CSV_nominal.eval_auto_bounds("down_hf", BTagEntry::FLAV_UDSG, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    //no uncertainty on contamination from LF sample when computing LF scale factors
					double mycsv_weight_LF_ak4lfstats1Up = CSV_nominal.eval_auto_bounds("up_lfstats1", BTagEntry::FLAV_UDSG, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_LF_ak4lfstats1Down = CSV_nominal.eval_auto_bounds("down_lfstats1", BTagEntry::FLAV_UDSG, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_LF_ak4lfstats2Up = CSV_nominal.eval_auto_bounds("up_lfstats2", BTagEntry::FLAV_UDSG, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
                    double mycsv_weight_LF_ak4lfstats2Down = CSV_nominal.eval_auto_bounds("down_lfstats2", BTagEntry::FLAV_UDSG, fabs(AK4Jets->at(i).Eta()), AK4Jets->at(i).Pt(), AK4JetBtag->at(i));
