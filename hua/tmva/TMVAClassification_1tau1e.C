...
int TMVAClassification_1tau1e( TString myMethodList = "" )
{
   ...
   TString outfile = "1tau1e_step5AddMoreVariables";
   ...
   // dataloader->AddVariable( "myvar1 := var1+var2", 'F' );//’F’ indicates any floating point type, i.e., float and double
    ...
    if ( forVariables ){
        ...
        // dataloader->AddVariable( "jets_4largestBscoreSum", 'F' );//step 3
        // dataloader->AddVariable( "bjetsM_num", 'I' );//step 3
        dataloader->AddVariable( "bjetsM_3pt", 'F' ); // 5
        // dataloader->AddVariable( "bjetsL_num", 'I' );//step 2
        ...
        // dataloader->AddVariable( "toptagger_transMass", 'F' );//step 3
        ...
        dataloader->AddVariable( "bjetsM_2pt", 'F' );//step 5
