...
def main():
    ...
    inputDir = '/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2018/v2cut1tau1lSR6thJetpt32_v75OverlapRemovalFTau/mc/'
    ...
    command = './my_program {} {} 0 {} {} {}'.format(inputDir, outDir, varList, g_weight, channel) 
