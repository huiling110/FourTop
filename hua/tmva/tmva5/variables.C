...
void variables( 
        ...
        TString fin = "/publicfs/cms/user/huahuil/TauOfTTTT/2016v1/TMVAOutput/v13etaPhiAbs_v42_addNonBjets/1Tau0L_variables.root",
        TString dirName = "InputVariables_Id", TString title = "TMVA Input Variables",
