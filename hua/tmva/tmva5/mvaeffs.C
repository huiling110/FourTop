...
#include "tmvaglob.C"
// #include "tmvaglob.h"
// #include "/workfs2/cms/huahuil/4topCode/CMSSW_10_2_20_UL/src/FourTop/hua/tmva/tmva5/tmvaglob.h"
...
StatDialogMVAEffs::StatDialogMVAEffs(TString ds,const TGWindow* p, Float_t ns, Float_t nb) :
   fNSignal(ns),
   fNBackground(nb),
   fFormula(""),
   fInfoList(0),
...
void mvaeffs(TString dataset = "dataset",
