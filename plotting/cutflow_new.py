...
def main():
    ...
    OSdir = '/publicfs/cms/user/turuobing/tauOfTTTT_NanoAODOfficial/UL2018/v86HadroPreSelWithGammaRemoval_1tau0l_nb3PtHtChange/'
...
def histogram_to_dataframe(hist_dict):
    ...
    df = pd.DataFrame.from_dict(dic, orient='index', columns=['initial', 'METFilter', 'HLT', 'tauF>=1', 'jet>=6', 'bjet>1', 'Nb>=3HT>480&6thjet>38', 'Nb>=3HT>500&6thjet>40', 'OverlapRemoved'])
    ...
    selected_columns = df[['Process', 'Nb>=3HT>480&6thjet>38', 'Nb>=3HT>500&6thjet>40']]
    new_df = pd.DataFrame(selected_columns)
    new_df['Nb>=3HT>480&6thjet>38'] = pd.to_numeric(df['Nb>=3HT>480&6thjet>38'], errors='coerce')
    new_df['Nb>=3HT>500&6thjet>40'] = pd.to_numeric(df['Nb>=3HT>500&6thjet>40'], errors='coerce')
    new_df['Reduction Percentage'] = ((new_df['Nb>=3HT>480&6thjet>38'] - new_df['Nb>=3HT>500&6thjet>40']) / new_df['Nb>=3HT>480&6thjet>38']) * 100
