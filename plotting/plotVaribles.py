...
def main():
    ...
    variables = ['bjetsM_minDeltaR',  'tausT_1lepton1_deltaR', 'jets_sphericity', 'jets_centrality', 'bjetsM_leptons_minDeltaR', 'jets_rationHT_4toRest', 'jets_minDeltaR', 'jets_METDivideHT', 'jets_average_deltaR', 'jets_aplanarity', 'bjetsM_tausT_minDeltaR', 'bjetsM_3pt', 'bjetsM_invariantMass', 'tausT_1lepton1_deltaR' , 'tausT_1lepton1Met1_stransMass'] #BDT input
