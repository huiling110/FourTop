...
def main():
    ...
    # inputDir = '/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2018/v0baselineHardro_v84HadroPresel/mc/variableHists_v0BDT1tau1lBinFv2/'
    ...
    variables = ['BDT']
    regionList = ['1tau1lSR', '1tau1lCR1', '1tau1lCR2', '1tau1lCR12']
