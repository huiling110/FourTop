...
def main():
    ...
    inputDir = '/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2018/v1baselineHardroNewTriSFBinK_v75OverlapRemovalFTau/mc/variableHists_v0dataMC_allCorrection/'
