...
def main():
    ...
    # variables = ['jets_num', 'jets_HT',  'jets_6pt', 'bjetsM_num', 'tausF_1decayMode', 'tausF_1pt', 'tausF_1jetPt', 'tausF_1jetEtaAbs', 'tausF_1prong', 'tausF_num']
    ...
    # plotNormal(inputDirDic, variables, regionList, plotName, era, isRun3)

    plotFakeTau(inputDirDic, variables, regionList, plotName, era, isRun3, ifFTau)
   
def plotNormal(inputDirDic, variables, regionList, plotName, era, isRun3):
...
def makeStackPlotNew(nominal, legendOrder, name, region, outDir, ifFakeTau, savePost = "", era='2016', includeDataInStack=True, signalScale = 1000, ifStackSignal = False, ifLogy=False):
    '''
