...
def main():
    ...
    inputDir = '/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2018/v0baseline1tau2l_v2_v84fakeLeptonUpdate/mc/variableHists_v1dataMC_allbutHLTFakeLepton/'
    channel = '1tau2l'
