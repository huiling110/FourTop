...
if args.year == "2018":
    import input.VLL_Charis_2018 as tttt_Charis
if args.year == "2017":
    import input.VLL_Charis_2017 as tttt_Charis
if args.year == "2016":
    import input.VLL_Charis_2016post as tttt_Charis
if args.year == "2016APV":
    import input.VLL_Charis_2016APV as tttt_Charis
...
def copySingleFile():
    for isam, ifile in tttt_Charis.filesetSignal.items():
        ...
        #if not "M550" in outName: continue
