...
def StartPlotiing(file_path, base_name, up_name, down_name):
    ...
    # 保存图像
    # c1.SaveAs(f"/afs/ihep.ac.cn/users/t/turuobing/CMSSW_10_6_20/src/FourTop/plotting/TemplatCheckPlot/{title}.png")
    outDir = '/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2018/v0baselineHardro_v84HadroPresel/mc/variableHists_v0BDT1tau1lBinGv2/combine/results/'
...
def main():
    ...
    file_path = "/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2018/v0baselineHardro_v84HadroPresel/mc/variableHists_v0BDT1tau1lBinGv2/combine/templatesForCombine1tau1l.root"
    # channel = "1tau2l"
    channel = "1tau1l"
