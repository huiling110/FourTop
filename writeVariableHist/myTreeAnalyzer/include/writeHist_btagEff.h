...
private:
    ...
    TH1D *de_jetsPt_eta1_b = new TH1D("jets_ptEta1_de", "jet_pt", std::size(bins) - 1, bins);
    TH1D *nu_jetsPt_eta1_b = new TH1D("jets_ptEta1_nu", "jet_pt", std::size(bins) - 1, bins);
    TH1D *de_jetsPt_eta2_b = new TH1D("jets_ptEta2_de", "jet_pt", std::size(bins) - 1, bins);
    TH1D *nu_jetsPt_eta2_b = new TH1D("jets_ptEta2_nu", "jet_pt", std::size(bins) - 1, bins);
