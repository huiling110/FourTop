...
namespace WH
{
inline constexpr std::map<TString, TString> triggerSF_map = {
...
inline constexpr std::map<TString, TString> btagR_map = {
...
inline constexpr std::map<TString, std::array<TString, 2>> BDTTrainingMap = {
