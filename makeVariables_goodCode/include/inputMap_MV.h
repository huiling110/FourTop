...
namespace MV
{
    ...
    inline const std::map<TString, TString> triggerSF_map = {
        ...
        {"2018", "/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/forMVA/2018/v0baselineHT450Jet6pt32_v75NoHLTNoTauHT400Jet6pt30/mc/variableHists_v4HLT_4bDifBinningDifBBinA/results/"}
    };
