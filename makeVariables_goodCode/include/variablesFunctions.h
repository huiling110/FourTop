...
Double_t calBtagShapeWeight(const std::vector<Double_t> &jets_pt, const std::vector<Double_t> &jets_eta, const std::vector<Int_t> &jets_flavour, const std::vector<Double_t> &jets_btag, correction::CorrectionSet *cset_btag, Bool_t isData, const std::string sys);
...
Double_t calBtagWPMWeight(const std::vector<Double_t> &jets_pt, const std::vector<Double_t> &jets_eta, const std::vector<Int_t> &jets_flavour, const std::vector<Double_t> &jets_btag, correction::CorrectionSet *cset_btag, TH2D *btagEff_b, TH2D *btagEff_c, TH2D *btagEff_l, TH2D *btagTEff_b, TH2D *btagTEff_c, TH2D *btagTEff_l, Bool_t isData, TString era, const std::string sys, const Bool_t isRun3, const Bool_t ifBTagT=kFALSE,  const UChar_t ifBC = 0);
