...
WeightVarMaker::WeightVarMaker(TTree *outTree, TString era, Bool_t isData, const Bool_t isRun3, const TString processName): m_era{era}, m_isData{isData}, m_isRun3{isRun3}, m_processName{processName}
{
    ...
    std::cout<<"ele SF json="<<base + MV::json_map.at(m_era).at(3)<<"\n";  
...
void WeightVarMaker::makeVariables(EventForMV *e, const Double_t jets_HT,  Double_t jets_6pt, const Int_t jets_num, const Int_t bjetsM_num, const JetVarMaker* jetVarMaker)
{
    ...
    btagShape_weight_hf_down = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "down_hf");
    btagShape_weight_hfstats1_up = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "up_hfstats1");
    btagShape_weight_hfstats1_down = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "down_hfstats1");
    btagShape_weight_hfstats2_up = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "up_hfstats2");
    btagShape_weight_hfstats2_down = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "down_hfstats2");
    btagShape_weight_lfstats1_up = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "up_lfstats1");
    btagShape_weight_lfstats1_down = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "down_lfstats1");
    btagShape_weight_lfstats2_up = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "up_lfstats2");
    btagShape_weight_lfstats2_down = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "down_lfstats2");
    btagShape_weight_cferr1_up = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "up_cferr1");
    btagShape_weight_cferr1_down = calBtagShapeWeight(jets_pt, jets_eta, jets_flavour, jets_btags_vec, cset_btag.get(), m_isData, "down_cferr1");
