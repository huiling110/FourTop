...
void run_objectSelection(
    ...
    TString inputBase = "/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/UL2017/v66TheoryWeightAdded/mc/",
    // TString inputBase = "/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/2022postEE/v0for2022NoHLT/mc/",
    // TString inputBase = "/publicfs/cms/user/huahuil/tauOfTTTT_NanoAOD/2022postEE/v0for2022baseline/data/",
    TString inputDir = "tttt",
    // TString inputDir = "TTTT",
    // TString inputDir = "ttbar_0l",
    // TString inputDir = "ttbar_1l",
    // TString inputDir = "jetHT_2017f",
    // TString inputDir = "JetMET2022E",
    // TString inputDir = "ttbar_1l",
