...
Scan and display all active plans from `dev-docs/active/` directory.
...
[Task Name 1]
  ...
  Location:     dev-docs/active/task-name-1/
...
[Task Name 2]
  ...
  Location:     dev-docs/active/task-name-2/
...
5. **Additional information**:
   - Provide quick links to view each plan: "Use `Read dev-docs/active/[task-name]/plan.md` to view details"
