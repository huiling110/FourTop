...
- **Files**: 970,553 / 1,000,000 (97% used) ⚠️ **CRITICAL**
- **Disk space**: 8.5TB / 10TB (79% used) - OK
- **Problem**: File number quota, not disk space
- **Root cause**: 4,980 `variableHists_v*` directories with many small histogram files
...
**Phase 4**: Execute Cleanup (IN PROGRESS - 2025-11-27 14:00)
- 🚀 Running: `python3 cleanup_logs_jobsh.py --cleanup --execute --yes`
- Processing 1,636 histogram directories
- Zipping log/ directories, deleting jobSH/ directories
