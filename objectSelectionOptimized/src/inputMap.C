...
std::map<TString, std::array<TString, 3>> eleScaleSmear = {
    ...
    {"2016preVFP", {"../../jsonpog-integration/POG/EGM/ScaleFactorsJSON/2016preVFP_UL/EGM_ScaleUnc.json", "UL-EGM_ScaleUnc", "2022Re-recoE+PromptFG_SmearingJSON"}},
    {"2016postVFP", {"../../jsonpog-integration/POG/EGM/ScaleFactorsJSON/2016postVFP_UL/EGM_ScaleUnc.json", "UL-EGM_ScaleUnc", "2022Re-recoE+PromptFG_SmearingJSON"}},
    {"2017", {"../../jsonpog-integration/POG/EGM/ScaleFactorsJSON/2017_UL/EGM_ScaleUnc.json", "UL-EGM_ScaleUnc", "2022Re-recoE+PromptFG_SmearingJSON"}},
