...
void run_objectSelection(
    ...
    const UChar_t TES = 4, //no correction; 1: up; 2: down; 3: up, decayMode=0; 4: down, decayMode=0; 5: up, decayMode=1; 6: down, decayMode=1; 7: up, decayMode=10; 8: down, decayMode=10; 9: up, decayMode=11; 10: down, decayMode=11
    // const UChar_t TES = 4;
    ...
    Int_t eventNum = 3000) // Int_t eventNum = 10000)
// Int_t eventNum = 0)
{
    TStopwatch t;
    t.Start();
