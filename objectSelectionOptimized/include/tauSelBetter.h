#ifndef TauSelBetter_H
#define TauSelBetter_H
...
{
public:
    TauSelBetter(TTree *outTree, const TString era, Bool_t isData, Bool_t isRun3, const Int_t tauWP = 3, const UChar_t TES = 0);
    ~TauSelBetter();
