...
private:
    ...
    EleTopMVASel eleTopMVATSel{m_outTree, m_era, m_isData, m_isRun3, 2, m_eleScale, m_eleSmear};
    EleTopMVASel eleTopMVAFSel{m_outTree, m_era, m_isData, m_isRun3, 1, m_eleScale, m_eleSmear};
    ...
    JetSel bjetMSel{m_outTree, m_era,m_processName,  m_isRun3, m_isData, 12, m_JESSys, m_JERSys};
    JetSel bjetTSel{m_outTree, m_era, m_processName, m_isRun3, m_isData, 13, m_JESSys, m_JERSys};
