...
void HLTstudy_v1(){
    ...
    // for (UInt_t i=1; i<channels.size(); i++){
        ...
        std::cout<<"global efficiency of "<<channelNames[i]<<":"<<endl;
        TH1F *denominator = new TH1F("1tau0l_de", "1tau0l_de", 2, 0, 2);
        TH1F *numerator   = new TH1F("1tau0l_nu", "1tau0l_nu", 2, 0, 2);
        // tree_TTTT->Project( "1tau0l_de", "HLT_PFHT450_SixJet40_BTagCSV_p056", channel_1tau0l);
        tree_TTTT->Project( "1tau0l_de", "HLT_PFHT450_SixJet40_BTagCSV_p056", channels[i]);
        // tree_TTTT->Project( "1tau0l_nu", "HLT_PFHT450_SixJet40_BTagCSV_p056", channel_1tau0l && HLTset_1tau0l);
